...
public class MySpringDataJpaDemo {
	...
	public void doCrudRepositoryDemo() {
		...
		Employee saved1 = crudRepository.save(new Employee(10076, "Method Man", "Park Hill Projects, New York", 23000));
		System.out.println("Inserted record: " + saved1);

		System.out.println("\nInserting record with save() [id = 10109]...");
		Employee saved2 = crudRepository.save(new Employee(10109, "Inspectah Deck", "The Bronx, New York", 26300));
		System.out.println("Inserted record: " + saved2);

		System.out.println("\nInserting record with save() [id = 10164]...");
		Employee saved3 = crudRepository
				.save(new Employee(10164, "Ol' Dirty Bastard", "Queens Bridge, New York", 24500));
		System.out.println("Inserted record: " + saved3);
